...
# test
python test.py multi_pose --exp_id train_dla_chenwang_neck --dataset chen_wang_neck --num_joints 18 --keep_res --load_model ../exp/multi_pose/train_dla_chenwang_neck/model_last.pth
# flip test
